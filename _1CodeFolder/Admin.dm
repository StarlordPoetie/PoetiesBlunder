var/list
	CodedAdmins=list("NWKY"=3, "Sunshine Jesse"=4, "Nightmare Zarkus"=4, "NeoGalaxyEyesPhotonDragon"=4, "Lanni.k"=4, "Antenora Luxuria"=4, "Admindred"=4, "Hadoke"=3, "Poetiethegreat"=4)
	Admins=list()
	Mappers=list()
	Punishments=list()
